...
#
# Generated by export_simulation on Wed Oct 04 16:35:04 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './Top_Student.sh' script.

./Top_Student.sh -reset_run
...
./Top_Student.sh -noclean_files

For more information on the script, please type './Top_Student.sh -help'.
